...
block_stmt
        : KW_BLOCK
          ...
          LL_BLOCK
          {
            ...
            CHECK_ERROR(cfg_lexer_register_block(lexer, cfg_lexer_lookup_context_type_by_name($3), $4, block) || cfg_allow_config_dups(configuration), @4, "duplicate block definition");
            free($3);
            free($4);
            free($10);
