...
main(int argc, char *argv[])
{
  ...
  testcase("all-macros", NULL,
      ...
      "HOUR12,ISODATE,LEVEL,LEVEL_NUM,MESSAGE,MIN,MONTH,MONTHNAME,MONTH_ABBREV,MONTH_NAME,MONTH_WEEK,MSEC,MSG,MSGHDR,OSUPTIME,PRI,PRIORITY,PROCESS_ID,P_AMPM,"
